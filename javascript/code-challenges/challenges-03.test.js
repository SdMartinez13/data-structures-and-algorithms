...
const typeNum = (arr) => {
  // Solution code here...
  let filArr = arr.filter(num => typeof(num) === 'number');
  return filArr;
...
const containsAnd = (arr) => {
  // Solution code here...
  let newArr = arr.filter(str => str.includes('and') === true);
  return newArr;
};
...
//got help from stackoverflow "filter even numbers"
...
//got help from https://stackoverflow.com/questions/30389599/comparing-and-filtering-two-arrays
/* ------------------------------------------------------------------------------------------------
